...
public class TaskRepository {
    ...
    public void generateData() {
        save((Task.of("Vacaciones", "Quiero vacaciones", "Vacaciones", Status.DRAFT.toString(), "2020-01-01", "2020-01-31", 5l, Difficulty.HARDCORE.toString())));
    ...
    public Task findByIdTask(Long idTask) {
        ...
        return tasks.stream().filter(x -> x.getIdTask().equals(idTask)).findFirst().orElseThrow(() -> new NotFoundException("Task not found"));
    }
