...
public class GroupController {
    ...
    protected static GroupController instance = null; // La instancia inicialmente no existe, se crea al ejecutar .getInstance().
    ...
    public static GroupController getInstance() {
        instance = (instance == null) ? new GroupController() : instance; // Creamos una instancia si no existe.
        return instance;
    }
